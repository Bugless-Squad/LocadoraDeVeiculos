...
namespace LocadoraDeVeiculos.Dominio.Compartilhado.Validators
{
    public static class ValidatorExtensions
    {
        ...
        public static IRuleBuilderOptions<T, string> NaoPodeNumeros<T>(this IRuleBuilder<T, string> ruleBuilder)
        {
            return ruleBuilder.SetValidator(new NaoPodeNumerosValidator<T>());
        }
